  ...
  <div class="space-y-4">
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-3">
        <el-select v-model="filterSubject" placeholder="全部学科" clearable size="small" style="width:120px" @change="loadNotes">
    ...
    <div v-else-if="notes.length === 0" class="text-center py-16 text-gray-400">
      <span class="text-5xl">📝</span>
      <p class="mt-4 text-lg">还没有笔记，记录你的第一篇笔记吧</p>
      <el-button type="primary" class="mt-4" @click="createNote">新建笔记</el-button>
    </div>
